...
public class NoAttach extends SuperTestNG {
	...
	public static void Sendmail() throws Exception {
		...
		String msg = "<p>Hello Team,<br> <br>"
				+ "please click on the below link to check the <strong>Shop.ng</strong> Automation Suite <strong>Report.</strong>"
				+ "</p>http://10.2.0.23/ShopReport/Shop-"+date.format(timestamp)+".html"
				+ "<br><br>Thanks<br />" + "Unicity QA Team";
		
		message.setSubject("ShoppingCart India Market Automation Report");
