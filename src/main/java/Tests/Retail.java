...
public class Retail extends SuperTestNG {
	...
	public void RetailOrder() throws InterruptedException, IOException {
		...
		childtest = Retail.createNode("Retail Customer");
		childtest.log(Status.INFO, "<a href=https://shop.unicity.com/#/home>"+"shop live url"+"</a>");
		
		HP.select_state();
		HP.retail_home_page();
		
		HP.retail_all_producst();
		HP.retail_products();
		HP.retail_accessories();
		
		HP.reatil_all_products_in_list_view();
		HP.retail_products_in_list_view();
		HP.retail_accessories_in_list_view();
